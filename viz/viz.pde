...
//Input path
String DIR = "../output/我们村里的年轻人（续集）"; //Set this to the resuls folder of a video or an image folder
...
//Experimental
boolean tsne1D = true; //Requires a "tsne-1d.csv" generated by src/tsne.py with arg --one_dimension
